...
public class SmartTrapScore extends SequentialCommandGroup {

  public SmartTrapScore(TrampulatorSubsystem trampulator) {
    addCommands(
        new TrampulatorManipulatorSpin(trampulator, 0.2),
        new WaitCommand(1),
        new TrampulatorManipulatorSpin(trampulator, 0),

        new TrampulatorManipulatorOrient(trampulator, Constants.TrampulatorConstants.trampulatorOrientTrap)
        .alongWith(new TrampulatorWristGoToPosition(trampulator, Constants.TrampulatorConstants.trampulatorWristTrap)),
        new TrampulatorManipulatorSpin(trampulator, -0.2),
        new WaitCommand(1),
        new TrampulatorManipulatorSpin(trampulator, 0),
