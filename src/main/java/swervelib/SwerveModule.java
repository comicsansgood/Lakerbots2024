...
public class SwerveModule
{
  ...
  public void updateTelemetry()
  {
    ...
    SmartDashboard.putNumber("Module[" + configuration.name + "] Raw Motor ANGLE Encoder", angleMotor.getPosition());
    SmartDashboard.putNumber("Module[" + configuration.name + "] Raw DRIVE encoder", driveMotor.getPosition());//custom 
